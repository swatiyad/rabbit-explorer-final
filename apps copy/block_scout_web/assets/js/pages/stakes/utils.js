...
export function isSupportedNetwork (store) {
  ...
  openWarningModal('Unauthorized', 'Please, connect to the Analog Chain.<br /><a href="https://rabbit.analogscan.com" target="_blank">Instructions</a>. If you have already connected to, please update MetaMask to the latest version.')
  return false
}
